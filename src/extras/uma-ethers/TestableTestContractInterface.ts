...
interface TestableTestInterface extends ethers.utils.Interface {
  ...
  encodeFunctionData(functionFragment: "getTestableTimeAndBlockTime", values?: undefined): string
  ...
  decodeFunctionResult(functionFragment: "getTestableTimeAndBlockTime", data: BytesLike): Result
