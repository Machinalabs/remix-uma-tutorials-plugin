...
interface MockOracleInterface extends ethers.utils.Interface {
  ...
  decodeFunctionResult(functionFragment: "getPendingQueries", data: BytesLike): Result
...
export interface MockOracle extends Contract {
  ...
  estimateGas: {
    ...
    pushPrice(identifier: BytesLike, time: BigNumberish, price: BigNumberish): Promise<BigNumber>
