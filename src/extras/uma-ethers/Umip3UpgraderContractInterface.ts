...
interface Umip3UpgraderInterface extends ethers.utils.Interface {
  ...
  encodeFunctionData(functionFragment: "existingGovernor", values?: undefined): string
  encodeFunctionData(functionFragment: "existingVoting", values?: undefined): string
  ...
  decodeFunctionResult(functionFragment: "existingGovernor", data: BytesLike): Result
  decodeFunctionResult(functionFragment: "existingVoting", data: BytesLike): Result
