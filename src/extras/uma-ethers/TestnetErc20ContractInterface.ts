...
interface TestnetErc20Interface extends ethers.utils.Interface {
  ...
  encodeFunctionData(functionFragment: "allocateTo", values: [string, BigNumberish]): string
...
export interface TestnetErc20 extends Contract {
  ...
  callStatic: {
    allocateTo(ownerAddress: string, value: BigNumberish, overrides?: Overrides): Promise<void>
  ...
  populateTransaction: {
    allocateTo(ownerAddress: string, value: BigNumberish): Promise<PopulatedTransaction>
