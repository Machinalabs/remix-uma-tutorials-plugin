...
interface VoteTimingTestInterface extends ethers.utils.Interface {
  ...
  encodeFunctionData(functionFragment: "wrapComputeCurrentPhase", values: [BigNumberish]): string
  encodeFunctionData(functionFragment: "wrapComputeCurrentRoundId", values: [BigNumberish]): string
  encodeFunctionData(functionFragment: "wrapInit", values: [BigNumberish]): string

  decodeFunctionResult(functionFragment: "voteTiming", data: BytesLike): Result
  decodeFunctionResult(functionFragment: "wrapComputeCurrentPhase", data: BytesLike): Result
  decodeFunctionResult(functionFragment: "wrapComputeCurrentRoundId", data: BytesLike): Result
...
export interface VoteTimingTest extends Contract {
  ...
  populateTransaction: {
    ...
    wrapComputeCurrentPhase(currentTime: BigNumberish): Promise<PopulatedTransaction>
    wrapComputeCurrentRoundId(currentTime: BigNumberish): Promise<PopulatedTransaction>
