...
interface StoreInterface extends ethers.utils.Interface {
  ...
  encodeFunctionData(functionFragment: "SECONDS_PER_WEEK", values?: undefined): string
  ...
  encodeFunctionData(functionFragment: "fixedOracleFeePerSecondPerPfc", values?: undefined): string
  ...
  decodeFunctionResult(functionFragment: "SECONDS_PER_WEEK", data: BytesLike): Result
  ...
  decodeFunctionResult(functionFragment: "fixedOracleFeePerSecondPerPfc", data: BytesLike): Result
  ...
  getEvent(nameOrSignatureOrTopic: "NewFixedOracleFeePerSecondPerPfc"): EventFragment
  getEvent(nameOrSignatureOrTopic: "NewWeeklyDelayFeePerSecondPerPfc"): EventFragment
