...
interface MockAdministrateeInterface extends ethers.utils.Interface {
  ...
  encodeFunctionData(functionFragment: "timesEmergencyShutdown", values?: undefined): string
  encodeFunctionData(functionFragment: "timesRemargined", values?: undefined): string
  ...
  decodeFunctionResult(functionFragment: "timesEmergencyShutdown", data: BytesLike): Result
  decodeFunctionResult(functionFragment: "timesRemargined", data: BytesLike): Result
