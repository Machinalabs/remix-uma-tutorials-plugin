...
interface GovernorTestInterface extends ethers.utils.Interface {
  ...
  encodeFunctionData(functionFragment: "addPrefix", values: [BytesLike, BytesLike, BigNumberish]): string
  encodeFunctionData(functionFragment: "constructIdentifier", values: [BigNumberish]): string
  ...
  encodeFunctionData(functionFragment: "uintToUtf8", values: [BigNumberish]): string

  decodeFunctionResult(functionFragment: "addMember", data: BytesLike): Result
  decodeFunctionResult(functionFragment: "addPrefix", data: BytesLike): Result
  decodeFunctionResult(functionFragment: "constructIdentifier", data: BytesLike): Result
...
export interface GovernorTest extends Contract {
  ...
  addPrefix(input: BytesLike, prefix: BytesLike, prefixLength: BigNumberish, overrides?: CallOverrides): Promise<string>

  constructIdentifier(id: BigNumberish, overrides?: CallOverrides): Promise<string>
  ...
  estimateGas: {
    ...
    addPrefix(input: BytesLike, prefix: BytesLike, prefixLength: BigNumberish): Promise<BigNumber>
    constructIdentifier(id: BigNumberish): Promise<BigNumber>
    ...
    uintToUtf8(v: BigNumberish): Promise<BigNumber>
  }

  populateTransaction: {
    addMember(roleId: BigNumberish, newMember: string): Promise<PopulatedTransaction>
    addPrefix(input: BytesLike, prefix: BytesLike, prefixLength: BigNumberish): Promise<PopulatedTransaction>
    constructIdentifier(id: BigNumberish): Promise<PopulatedTransaction>
    ...
    uintToUtf8(v: BigNumberish): Promise<PopulatedTransaction>
  }
}
