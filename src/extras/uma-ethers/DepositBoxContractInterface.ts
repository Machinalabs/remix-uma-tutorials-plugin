...
interface DepositBoxInterface extends ethers.utils.Interface {
  ...
  decodeFunctionResult(functionFragment: "totalDepositBoxCollateral", data: BytesLike): Result
...
export interface DepositBox extends Contract {
  ...
  callStatic: {
    ...
    executeWithdrawal(overrides?: Overrides): Promise<{ rawValue: BigNumber; 0: BigNumber }>
  ...
  filters: {
    Deposit(user: string | null, collateralAmount: BigNumberish | null): EventFilter
  ...
  estimateGas: {
    ...
    requestWithdrawal(denominatedCollateralAmount: { rawValue: BigNumberish }): Promise<BigNumber>
