...
interface Transaction { // TODO

}

type EventsType = 'onCollateralDeployed' | 'onPriceIdentifierDeployed' | 'onExpiringMultiPartyDeployed' | 'onNewPositionCreated' | 'onReedemedToken' | 'onNewDeposit' | 'onNewWithdraw'
