  ...
  return (
    <BootstrapForm.Row>
      <BootstrapForm.Group as={Col}>
        <BootstrapForm.Label style={{ color: themeType === "dark" ? undefined : 'black', paddingLeft: "0" }} column={true}>
          {label}
        </BootstrapForm.Label>
...
const CustomInputComponent = (props: Props) => {
  ...
  return (<div style={{ display: "flex", flexDirection: "row", justifyContent: "center", alignItems: "center" }}>
    <BootstrapForm.Control type="text" key="name" size="sm" placeholder={props.field} {...props} style={{ marginRight: "10px" }} />
    {props.showHelp &&
